defmodule BrianWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(BrianWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(BrianWeb.Gettext, "errors", msg, opts)
    # end
  ...
  attr :variant, :string, default: "elixir"
  slot :inner_block, required: true
